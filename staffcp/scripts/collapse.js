...
function save_collapsed(A, E) {
    var D = fetch_cookie("ts_admin_collapse");
    var C = [];
    if (D != null) {
        D = D.split("\n");
    ...
    set_cookie("ts_admin_collapse", C.join("\n"), expires)
}
