...
var_235();
$Language = file("languages/" . function_75() . "/unconfirmed_users.lang");
$Message = "";
...
list($pagertop, $limit) = function_82(25, $results, $_SERVER["SCRIPT_NAME"] . "?do=unconfirmed_users&amp;");
