...
var_235();
$Language = file("languages/" . function_75() . "/manage_faq.lang");
$Message = "";
...
if (0 < mysqli_num_rows($query)) {
    ...
    $Output[] = function_76(str_replace("{1}", "index.php?do=manage_faq&amp;$act = new_category", $Language[16]));
}
echo "\r\n" . function_81("<a $href = \"index.php?do=manage_faq&$act = new_category\">" . $Language[7] . "</a>") . "\r\n" . $Message . "\r\n<table $cellpadding = \"0\" $cellspacing = \"0\" $border = \"0\" class=\"mainTable\">\r\n\t<tr>\r\n\t\t<td class=\"tcat\" $align = \"center\">" . $Language[2] . "</td>\r\n\t</tr>\r\n\t<tr>\r\n\t\t<td class=\"alt1\">\r\n\t\t\t<table $cellpadding = \"4\" $cellspacing = \"0\" $border = \"0\" $align = \"center\" $width = \"100%\" $style = \"border-collapse:separate\">\r\n\t\t\t\t<tr>\r\n\t\t\t\t\t<td $valign = \"top\">";
