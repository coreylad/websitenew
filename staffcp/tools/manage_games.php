...
$Language = file("languages/" . function_75() . "/manage_games.lang");
$Message = "";
$List = "";
if ($Act == "delete" && $gid) {
        ...
        if (strtoupper($_SERVER["REQUEST_METHOD"]) == "POST") {
            ...
            if ($Game["gname"] && $Game["gwidth"] && $Game["gheight"] && $Game["cid"]) {
                ...
                if (is_file($GameFile)) {
                    ...
                    $Message = function_76($Language[28] . " <b>" . $GameFile . "</b>");
                }
            } else {
