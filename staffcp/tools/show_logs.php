...
var_235();
$Language = file("languages/" . function_75() . "/show_logs.lang");
...
list($pagertop, $limit) = function_82(25, $results, $_SERVER["SCRIPT_NAME"] . "?do=show_logs&amp;");
