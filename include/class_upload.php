...
class upload
{
    ...
    public function translate($str, $tokens = [])
    {
                ...
                if ($this->processed && $image_src) {
                        ...
                        for ($x = 0; $x < $this->image_src_x; $x++) {
                            for ($y = 0; $y < $this->image_src_y; $y++) {
                                if (0 <= $this->image_transparent_color && imagecolorat($image_src, $x, $y) == $this->image_transparent_color) {
                                    imagesetpixel($true_color, $x, $y, 2130706432);
                                } else {
                    ...
                    if (!empty($this->image_precrop)) {
                        ...
                        if ($ct < 0 || $cr < 0 || $cb < 0 || $cl < 0) {
                            ...
                            if ($ct < 0) {
                                imagefilledrectangle($tmp, 0, 0, $this->image_src_x, -1 * $ct, $fill);
                            }
                            if ($cr < 0) {
                            ...
                            if ($cl < 0) {
                                imagefilledrectangle($tmp, 0, 0, -1 * $cl, $this->image_src_y, $fill);
                            }
                        }
                    ...
                    if (!empty($this->image_crop) || !is_null($ratio_crop)) {
                        ...
                        if ($ct < 0 || $cr < 0 || $cb < 0 || $cl < 0) {
                            ...
                            if ($ct < 0) {
                                imagefilledrectangle($tmp, 0, 0, $this->image_dst_x, -1 * $ct, $fill);
                            }
                            if ($cr < 0) {
                            ...
                            if ($cl < 0) {
                                imagefilledrectangle($tmp, 0, 0, -1 * $cl, $this->image_dst_y, $fill);
                            }
                        }
                        $image_dst = $this->imagetransfer($tmp, $image_dst);
                    }
                        ...
                        for ($y = 0; $y < $this->image_dst_y; $y++) {
                            for ($x = 0; $x < $this->image_dst_x; $x++) {
                                if ($this->image_greyscale) {
                                    ...
                                    $r = $g = $b = round(0 * $pixel["red"] + 0 * $pixel["green"] + 0 * $pixel["blue"]);
                            ...
                            for ($x = 0; $x < $this->image_dst_x; $x++) {
                                for ($y = 0; $y < $this->image_dst_y; $y++) {
                                    if (imageistruecolor($image_dst)) {
                                        ...
                                        $pixel = ["red" => $rgba >> 16 & 255, "green" => $rgba >> 8 & 255, "blue" => $rgba & 255, "alpha" => ($rgba & 2130706432) >> 24];
                                    } else {
                                        $pixel = imagecolorsforindex($image_dst, imagecolorat($image_dst, $x, $y));
                                    }
                                    if ($pixel["alpha"] == 127) {
