...
<td class="text">
<ul>
<li><a class="altlink" href="getrss.php">RSS feed</a> - For use with RSS-enabled software. An alternative to torrent email notifications.</li>
<li><a class="altlink" href="ff.php">Firefox Plugins</a> - Put our search plugin in the Search Bar in the upper-right corner of Firefox.</li>
</ul>
</td>
</tr>
</table>
...
<li><a class="altlink" href="http://utorrent.com/">Utorrent</a> - Nice BitTorrent tracker</li>
...
<h2>Recommend Clients</h2>
<table width="100%" border="1" cellspacing="0" cellpadding="10">
<tr>
<td class="text">
<ul>
<li class="c5"><strong>Cross-Platform:</strong><br /></li>
<li>Azureus</li>
<li>BitTornado</li>
<li class="c5"><br />
<strong>Window Users:</strong><br /></li>
<li>?Torrent</li>
<li>ABC</li>
<li class="c5"><br />
<strong>Mac Users:</strong><br /></li>
<li>Tomato Torrent</li>
<li>BitRocket (lastest version)</li>
<li>rtorrent</li>
<li class="c5"><br />
<strong>Linux Users:</strong><br /></li>
<li>rtorrent</li>
<li>ktorrent</li>
<li>deluge</li>
</ul>
