...
(
	...
	'404'=>'<b>"404 - The requested URL could not be found on this site." </b><br />This means the page as it was entered in the URL does not exist on the server.<br />This is usually caused by someone incorrectly typing the URL, or by the web master renaming or moving an existing page to a different directory.',//Added in v7.2
	'recent_torrents' => 'Recent',//Added in v7.5
	'best_seeded' => 'Best Seeded',//Added in v7.5
	'best_rated' => 'Best Rated',//Added in v7.5
	'most_active' => 'Most Active',//Added in v7.5
	'most_downloaded' => 'Most Downloaded',//Added in v7.5
	'most_talked_about' => 'Most Talked About',//Added in v7.5
	'total_comments' => 'Total Comments',//Added in v7.5
);
?>