...
(
	...
	'info'					=>'<table class=main $width = 100% $border = 0 $cellspacing = 0 $cellpadding = 0><tr><td class=embedded>
...
on what exactly a file is or how to open it maybe your answer lies ahead. If you dont find your answer here, then please post in the "Forum". So without further adieu lets
