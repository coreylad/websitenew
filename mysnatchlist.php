...
echo ($is_mod ? "" : show_notice(sprintf($lang->mysnatchlist["notice"], mkprettytime($announce_interval), $NextAnnounce != "---" ? my_datee($dateformat, $NextAnnounce) . " " . my_datee($timeformat, $NextAnnounce) : $NextAnnounce))) . $pagertop . $ShowList . $pagerbottom;
stdfoot();
